 ...
 * which reads the same forward as backward, ignoring blanks and special characters like hyphens or
 * exclamation marks and upper or lower case. An empty string is not a palindrome. Examples are
 * <ul>
